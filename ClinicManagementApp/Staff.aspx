        ...
        <ajaxToolkit:TabPanel ID="TabPanelView" runat="server" HeaderText="View" class="tabPanel">
            ...
            <ContentTemplate>
                ...
                <div class="p-2">
                    ...
                    <asp:GridView ID="GridView_Staff" runat="server" AutoGenerateColumns="False" AutoGenerateSelectButton="True" AutoGenerateDeleteButton="True" OnRowDeleting="GridView_Staff_RowDeleting" CellPadding="4" ForeColor="#333333" GridLines="None" Width="100%" OnSelectedIndexChanged="GridView_Staff_SelectedIndexChanged" ShowHeaderWhenEmpty="true">
