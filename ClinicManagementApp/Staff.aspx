...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <ajaxToolkit:TabContainer ID="TabContainerStaff" runat="server" ActiveTabIndex="0" class="mb-3">
        ...
        <ajaxToolkit:TabPanel ID="TabPanelView" runat="server" HeaderText="View" class="tabPanel">
            ...
            <ContentTemplate>
                ...
                <div class="p-2">
                    ...
                    <asp:GridView ID="GridView_Staff" runat="server" AutoGenerateColumns="False" AutoGenerateDeleteButton="True" AutoGenerateSelectButton="True" OnRowDeleting="GridView_Staff_RowDeleting" CellPadding="4" ForeColor="#333333" GridLines="None" Width="100%" OnSelectedIndexChanged="GridView_Staff_SelectedIndexChanged">
